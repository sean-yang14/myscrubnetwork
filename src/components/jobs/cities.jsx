			...
			<div className='rounded-lg bg-white shadow-md flex justify-between p-4 mt-4 w-fit mx-auto'>
				<div className='relative flex space-x-4'>
					...
					<div>
						<button
							type='submit'
							className='h-fit w-fit mt-4 inline-flex justify-center rounded-md bg-indigo-600 px-8 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
						>
							Apply
						</button>
					</div>
